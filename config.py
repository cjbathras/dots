...
class Config(metaclass=Singleton):
    def __init__(self, rows: int=5, cols: int=5, cell_size: tuple=(100, 100), dot_radius: int=5,
                gutter_top: int=20, gutter_bottom: int=20, gutter_left: int=20, gutter_right: int=20,
                scoreboard_height: int=70, footer_height: int=70):
